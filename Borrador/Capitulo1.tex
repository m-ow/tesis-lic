...
\begin{defn} Sea \lean{r} una relación en \lean{A}.
\begin{enumerate}[(i)]

\item \lean{r} es \textbf{confluente} si su cerradura 
...
\item \lean{r} es \textbf{fuertemente confluente} si:
 \begin{center}
\begin{tikzpicture}
  \node (a) at (0, 2) {\lean{x}};
  \node (b) at (2, 2) {\lean{y₁}};
...
\begin{thm}[Hindley-Rosen]
Sean \lean{r₁} y \lean{r₂} dos relaciones sobre un mismo tipo. Si ambas son
confluentes y conmutan entre sí, entonces su unión \lean{r₁ ⊔ r₂} es
confluente.
\begin{leancode}
